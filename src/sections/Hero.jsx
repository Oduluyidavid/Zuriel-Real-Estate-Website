...
import tobi from "../assets/images/tobi55.png";
import Aos from "aos";
  ...
  return (
    <>
      <div className={`${darkMode ? "dark bg-black" : "light bg-white"}`}>
        <section id="home"className="w-[95] h-[600px] m-auto bg-cover bg-center flex  rounded-xl  justify-center flex-col items-start lg:px-28 px-10 gap-7 z-20"
      ...
      <div className={`${ darkMode ? "dark bg-black" : "light bg-transparent" } z-10`}>
        ...
        <div className="w-full">
          <button className=" bg-red-600 dark:bg-blue-700 hover:bg-black dark:hover:bg-white dark:hover:text-black text-lg p-4 w-full text-white font-semibold
